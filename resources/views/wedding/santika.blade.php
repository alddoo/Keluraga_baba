...
<body>
    ...
    <div class="gallery-grid">
         ...
         <a href="{{ url('/gallery/ayu-and-ralan') }}" class="card">
            <img src="{{ asset('img/foto_ayu/31.jpg') }}" alt="">
            <p>Ayu & Ralan</p>
        </a>

        <a href="{{ url('/gallery/nila-and-erlangga') }}" class="card">
            <img src="{{ asset('img/foto_nila/3.png') }}" alt="">
            <p> & </p>
        </a>
