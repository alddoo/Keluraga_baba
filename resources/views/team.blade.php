...
<body>
    ...
    <header class="nav">
        <div class="nav-left">
            <img src="{{ asset('logo/logo_kagoem.png') }}" class="logo-kagoem" alt="Kaia Logo">
            <img src="{{ asset('logo/Logo_baba[1].PNG') }}" class="logo-baba" alt="Baba Logo">
            <img src="{{ asset('logo/logo_Kaia.png') }}" class="logo-kaia" alt="Baba Logo">
        </div>
   ...
   <main class="team-page-content">
    ...
    <section class="founders-section">
        <div class="founder-card founder">
            <img src="{{ asset('anggota/Baba.png') }}" alt="Founder" class="founder-photo">
        ...
        <div class="founder-card owner">
            <img src="{{ asset('anggota/umi.png') }}" alt="Owner" class="founder-photo">
    ...
    <div class="founder-card founder">
        <img src="{{ asset('anggota/mia.png') }}" alt="Founder" class="founder-photo">
   ...
   <section class="member-grid">
    ...
    <div class="member-card">
        <img src="{{ asset('anggota/nabilah.png') }}" alt="nabilah" class="member-photo">
...
<div class="wrapper">
    ...
    <div class="section">
        ...
        <div class="scroll-box">
            <img src="{{ asset('baba Word 2025/poto2.jpeg') }}" alt="foto">
            <img src="{{ asset('baba Word 2025/poto1.jpeg') }}" alt="foto">
            <img src="{{ asset('baba Word 2025/poto3.jpeg') }}" alt="foto">
            <img src="{{ asset('baba Word 2025/poto4.jpeg') }}" alt="foto">
            <img src="{{ asset('baba Word 2025/poto5.jpeg') }}" alt="foto">
            <img src="{{ asset('baba Word 2025/poto6.jpeg') }}" alt="foto">
    ...
    <div class="section">
        ...
        <div class="scroll-box">
            <img src="{{ asset('team/1.JPG') }}" alt="foto">
